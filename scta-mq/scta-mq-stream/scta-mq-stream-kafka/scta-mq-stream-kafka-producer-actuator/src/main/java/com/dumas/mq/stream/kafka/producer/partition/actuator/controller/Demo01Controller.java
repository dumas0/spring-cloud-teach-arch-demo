package com.dumas.mq.stream.kafka.producer.partition.actuator.controller;

import com.dumas.mq.stream.kafka.producer.partition.actuator.message.Demo01Message;
