package com.dumas.scta.service.call.dubbo.filter.provider.filter;
            ...
            if (appResponse.hasException() && GenericService.class != invoker.getInterface()) {
                try {
                    ...
                    try {
                        ...
                        logger.warn("Got unchecked and undeclared exception which called by "
                                + RpcContext.getContext().getRemoteHost()
                                + ". service:" + invoker.getInterface().getName() + ", method:" + invocation.getMethodName()
                                + ",  exception:" + exception.getClass().getName() + ":" + exception.getMessage(), exception);

                        // direct throw if exception class and interface class are int the same jar file.
