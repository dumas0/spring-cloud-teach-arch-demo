...
public class UserRestTemplateController {
    ...
    public UserDTO get(@RequestParam("id") Integer id) {
        String url = String.format("http://%s/user/get?id=%d", "scta-service-call-dubbo-validation-provider", id);
    ...
    public Integer add(UserAddDTO addDTO) {
        ...
        // 执行请求
        String url = String.format("http://%s/user/add", "scta-service-call-dubbo-validation-provider");
